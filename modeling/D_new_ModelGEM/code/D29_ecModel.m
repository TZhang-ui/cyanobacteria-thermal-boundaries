...
newKcat = readmatrix('D29_kcat.tsv', 'FileType', 'text');
...
saveEcModel(ecModel,'D29_light_ecModel.yml' ); % Update filename if necessary

%% Reload EC model after modifications
ecModel = loadEcModel('D29_light_ecModel.yml');
...
writetable(fluxTable, 'D29_GECKO_light_Flux_samePro.csv');
