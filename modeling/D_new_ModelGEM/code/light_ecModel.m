...
% Ensure grRules and eccodes dimensions match reaction count
...
%% Display compartment names (optional)
unique(model.compNames)
...
%% Save EC model
saveEcModel(ecModel, 'D_light_ecModel.yml');
...
writetable(fluxTable, 'D25_GECKO_light_Flux.csv');
