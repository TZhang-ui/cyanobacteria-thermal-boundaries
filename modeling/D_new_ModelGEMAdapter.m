classdef D_new_ModelGEMAdapter < ModelAdapter
    methods
        function obj = D_new_ModelGEMAdapter()
            ...
            obj.params.path = fullfile('/Users/zhangtianyue/Desktop/genome/GSM/D/GECKO', 'D_new_ModelGEM');

			% Path to the conventional GEM that this ecModel will be based on.
			obj.params.convGEM = fullfile(obj.params.path,'models','D_0708.xml');
			...
			obj.params.gR_exp = 0.65;

			% Provide your organism scientific name
			obj.params.org_name = 'Dolichospermum flos-aquae';
			...
			obj.params.uniprot.ID = 'UP000502433'; % should match the ID type
