classdef M_newModelGEMAdapter < ModelAdapter
    methods
        function obj = M_newModelGEMAdapter()
            ...
            obj.params.path = fullfile('/Users/zhangtianyue/Desktop/genome/GSM/M/GECKO', 'M_newModelGEM');

			% Path to the conventional GEM that this ecModel will be based on.
			obj.params.convGEM = fullfile(obj.params.path,'models','M_Taihu98.xml');

			% Average enzyme saturation factor
			obj.params.sigma = 0.5;

			% Total protein content in the cell [g protein/gDw]
			obj.params.Ptot = 0.15;
			...
			obj.params.gR_exp = 0.69;

			% Provide your organism scientific name
			obj.params.org_name = 'Microcystis aeruginosa';
            
            % Taxonomic identifier for Complex Portal
            obj.params.complex.taxonomicID = 1134457;

			% Provide your organism KEGG ID, selected at
			% https://www.genome.jp/kegg/catalog/org_list.html
			obj.params.kegg.ID = 'mar';
			...
			obj.params.uniprot.ID = 'UP000010932'; % should match the ID type
            ...
            obj.params.uniprot.geneIDfield = 'Gene Names (ORF)';
			...
			obj.params.c_source = 'EX_cpd00011_e0'; 

			% Reaction ID for biomass pseudoreaction
			obj.params.bioRxn = 'bio1';
			...
			obj.params.enzyme_comp = 'Cytosol_0';
        end
