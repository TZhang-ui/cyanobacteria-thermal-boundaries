...
newKcat = readmatrix('M33_kcat.tsv', 'FileType', 'text');
...
saveEcModel(ecModel,'Mtaihu98_T33_ecModel.yml' ); % Update filename if necessary

%% Reload EC model after modifications
ecModel = loadEcModel('Mtaihu98_T33_ecModel.yml');
...
writetable(fluxTable, 'M33_GECKO_light_Flux_samePro.csv');
